...
grant delete on table "public"."test_table" to "postgres";

grant insert on table "public"."test_table" to "postgres";

grant references on table "public"."test_table" to "postgres";

grant select on table "public"."test_table" to "postgres";

grant trigger on table "public"."test_table" to "postgres";

grant truncate on table "public"."test_table" to "postgres";

grant update on table "public"."test_table" to "postgres";
